...
parser.add_argument("--id_path", type=str, default="src/ObjV1_curated.txt")
...
with open(args.id_path, 'r', encoding='utf-8') as file:
    lines = file.readlines()[args.start_idx:args.end_idx]
...
with open('download.txt', 'w') as f:
    for key, value in results.items():
        f.write(f'{value.replace("obj_v1/glbs/", "").replace(".glb", "")}\n')
